...
public class Alcancia {
    ...
    public int obtenerDenominacionMasNumerosa() {
        // TODO: Completar
    	int maxDenominacion = Math.max(numeroMonedas50, Math.max(numeroMonedas100, 
    ...
    public boolean valiosa() {
		...
		/*
		 * if ((numeroMonedas500 >= 1 && numeroMonedas1000 >= 1) && (numeroMonedas50 ==
		 * 0 && numeroMonedas100 == 0 && numeroMonedas200 == 0)) { return true; } else
		 */
        return ((numeroMonedas500 >= 1 || numeroMonedas1000 >= 1) && (numeroMonedas50 == 0 && numeroMonedas100 == 0 && numeroMonedas200 == 0));
    }
}
